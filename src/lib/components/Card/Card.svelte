...
<div
  class={[
    'card flex h-fit flex-col overflow-hidden rounded-2xl border border-border shadow-sm',
  ...
  <div
    ...
    tabindex="0"
    class={[
      'flex h-11 flex-none cursor-pointer items-center justify-between bg-muted/70 p-2 whitespace-nowrap',
      isTabsShown && 'pb-1'
    ]}
