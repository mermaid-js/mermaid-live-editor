    ...
    65470: (e, t, n) => {
      ...
      ((L = i || (i = {})).create = function (e, t) {
        ...
        (L.is = function (e) {
          var t = e;
          return (
            ue.objectLiteral(t) && ue.number(t.line) && ue.number(t.character)
          );
        }),
        ...
        (function (e) {
          (e.replace = function (e, t) {
            ...
            (e.is = function (e) {
              var t = e;
              return (
                ue.objectLiteral(t) && ue.string(t.newText) && r.is(t.range)
              );
            });
        })(_ || (_ = {})),
        (function (e) {
          (e.create = function (e, t) {
            ...
            (e.is = function (e) {
              var t = e;
              return (
                ue.defined(t) && C.is(t.textDocument) && Array.isArray(t.edits)
              );
            });
        })(w || (w = {})),
        (function (e) {
      ...
      !(function () {
        ...
        (function (e) {
          (e.create = function (e, t, n) {
            ...
            (e.is = function (e) {
              var t = e;
              return (
                t && ue.string(t.newText) && r.is(t.insert) && r.is(t.replace)
              );
            });
        })(N || (N = {})),
        (function (e) {
        ...
        (se.is = function (e) {
          ...
          return (
            void 0 !== t &&
            r.is(t.range) &&
            (void 0 === t.parent || se.is(t.parent))
          );
        }),
        (function (e) {
          function t(e, n) {
        ...
        (function (e) {
          e.LATEST = {
            textDocument: {
              completion: {
                completionItem: {
                  documentationFormat: [W.Markdown, W.PlainText],
                },
              },
          ...
          switch (h) {
                ...
                : ((h = ge.WithinEndTag),
                  ...
                  t < c.pos()
                    ? m(
                        t,
                        fe.Unknown,
                        xe('error.endTagNameExpected', 'End tag name expected.')
                      )
                    : f());
            ...
            case ge.WithinTag:
              return c.skipWhitespace()
                ...
                ? ((h = ge.AfterAttributeName),
                  (a = !1),
                  m(t, fe.AttributeName))
                      ...
                      return (
                        void 0 !== e.kind &&
                          (t.kind = (function (e) {
                            switch (e) {
                              case h.Comment:
                                return E.Mj.FoldingRangeKind.Comment;
                              case h.Imports:
                                return E.Mj.FoldingRangeKind.Imports;
                              case h.Region:
      ...
      function an(e) {
        ...
        return (
          ...
          sn(n),
          a.completionItems &&
            n.push(E.Mj.registerCompletionItemProvider(r, new jt(o))),
          ...
          a.documentSymbols &&
            n.push(E.Mj.registerDocumentSymbolProvider(r, new Yt(o))),
          a.rename && n.push(E.Mj.registerRenameProvider(r, new en(o))),
          a.foldingRanges &&
            n.push(E.Mj.registerFoldingRangeProvider(r, new tn(o))),
          a.selectionRanges &&
            n.push(E.Mj.registerSelectionRangeProvider(r, new nn(o))),
          a.documentFormattingEdits &&
            n.push(E.Mj.registerDocumentFormattingEditProvider(r, new Zt(o))),
          a.documentRangeFormattingEdits &&
            n.push(
              E.Mj.registerDocumentRangeFormattingEditProvider(r, new Qt(o))
            ),
